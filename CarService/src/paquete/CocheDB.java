...
public class CocheDB {
	...
	/**
	 * A�ade un coche a la base de datos.
	 * @param coche : Coche que se va a a�adir.
	 * */
	 ...
	 * 	(Es necesario que el 'id' del coche est� en la base de datos)
	 * */
	...
	/**
	 * Busca si existe un coche seg�n el modelo.
